...
const tokens = {
  ...
  primary: {
    ...
    "primary-200": { value: "#6EA3BE", description: "Itten Blue" },
    "primary-300": { value: "#6EA3BE", description: "Itten Blue" },
    "primary-400": { value: "#6EA3BE", description: "Itten Blue" },
    "primary-500": { value: "#6EA3BE", description: "Canonical Itten Blue (#6EA3BE)" },
    "primary-600": { value: "#5A8BA4", description: "Deepened Itten blue hover" },
    "primary-700": { value: "#3C6B84", description: "Accessible link text" },
    "primary-800": { value: "#284D62", description: "High contrast header" },
    "primary-900": { value: "#162F3E", description: "Deep Itten navy mark" },
    "primary-muted": { value: "#78716C", description: "Tonal warm multiply stone tone" },
    "primary-color": { value: "#6EA3BE", description: "Itten Blue" },
  },
  spectrum: {
