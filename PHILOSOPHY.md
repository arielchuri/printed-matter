# The Printed Matter Philosophy

## Ink on Paper: A Return to Physical Truth

Modern digital interfaces are clogged with simulated glass, faux 3D buttons, gratuitous drop shadows, and 12-step pastel tint ramps that drift endlessly out of alignment. 

**Printed Matter** proposes a radical return to the clarity and authority of the physical press sheet.

---

### 1. The Canvas is Paper (`#EFECE6`)
Screens are treated as warm, unbleached xerox bond paper. Blinding `#FFFFFF` glare is rejected as an unprinted ground. 

When `#FFFFFF` appears in Printed Matter, it is a **knockout** — an area where the plate was cut out to provide maximum contrast for technical readouts, search boxes, and high-legibility coordinates.
